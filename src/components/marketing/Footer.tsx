    ...
    <footer className="bg-gray-900 text-gray-300 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-xl text-white">Voxa</span>
            </div>
            <p className="text-sm text-gray-400">
              AI-powered voice assistant for seamless meeting participation.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-sm text-center text-gray-400">
          <p>&copy; 2026 Voxa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
